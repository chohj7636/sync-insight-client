...
const KnowledgeBasesInfo = () => {
  ...
  const {
    ...
    setSelectedOrganId,
    setType,
    setSelectedDataSource: setSelectedDataSourceSearchDirModal,
              ...
              <Button
                ...
                onClick={() => {
                  if (organInfo.organId) {
                    ...
                    setType('DIRECTORY');
                    setSelectedDataSourceSearchDirModal(selectedDataSource);
                    setClickConfirmButton(getSelectedDataSource);
                  } else {
                    toast('회원사를 선택해주세요.', {
                      duration: 2000,
                      position: 'top-center',
